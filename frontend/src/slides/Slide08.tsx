      ...
      <div className="flex h-full min-h-0 gap-4">
        <div className="flex min-h-0 w-[55%] flex-col">
          <div className="glass-panel min-h-0 flex-1 overflow-hidden rounded-xl">
            <table className="w-full text-left text-sm presentation:text-base">
              <thead>
          ...
          <p className="mt-3 shrink-0 text-xs italic text-slate-500 presentation:text-sm">{lintNote}</p>
        </div>
